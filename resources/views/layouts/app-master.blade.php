...
<head>
  ...
  <link rel="icon" href="{{asset('public/assets/img/favicon.ico')}}" type="image/x-icon"> <!-- Favicon-->
  <title>webtest</title>
  {{-- <title>SentiXTrade</title> --}}
  <!-- Application vendor css url -->
  <link rel="stylesheet" href="{{asset('public/assets/cssbundle/daterangepicker.min.css')}}">
  <link rel="stylesheet" href="{{asset('public/assets/vendor/jvectormap/jquery-jvectormap-2.0.5.css')}}">
  <!-- project css file  -->
  <link rel="stylesheet" href="{{asset('public/assets/css/luno-style.css')}}">
  <link rel="stylesheet" href="{{asset('public/assets/cssbundle/summernote.min.css')}}">
  <link rel="stylesheet" href="{{asset('public/assets/vendor/prismjs/prism.css')}}">
  <link rel="stylesheet" href="{{asset('public/assets/cssbundle/select2.min.css')}}">
...
<body class="layout-1 h-menu" data-luno="theme-blue">
          ...
          <div class="tab-content">
              ...
              <div class="card mb-3">
                ...
                <ul class="list-group list-group-flush list-group-custom custom_scroll mb-0" style="height: 300px;">
                  <li class="list-group-item d-flex align-items-center">
                    <img class="avatar rounded" src="{{asset('public/assets/img/xs/avatar1.jpg')}}" alt="">
                  ...
                  <li class="list-group-item d-flex align-items-center">
                    <img class="avatar rounded" src="{{asset('public/assets/img/xs/avatar2.jpg')}}" alt="">
                    <div class="flex-fill ms-2">
                  ...
                  <li class="list-group-item d-flex align-items-center">
                    <img class="avatar rounded" src="{{asset('public/assets/img/xs/avatar3.jpg')}}" alt="">
                    <div class="flex-fill ms-2">
                      <div class="h6 mb-0">Chris Fox</div>
                  ...
                  <li class="list-group-item d-flex align-items-center">
                    <img class="avatar rounded" src="{{asset('public/assets/img/xs/avatar4.jpg')}}" alt="">
                    <div class="flex-fill ms-2">
                      <div class="h6 mb-0">Chris Fox</div>
                  ...
                  <li class="list-group-item d-flex align-items-center">
                    <img class="avatar rounded" src="{{asset('public/assets/img/xs/avatar5.jpg')}}" alt="">
                    <div class="flex-fill ms-2">
                      <div class="h6 mb-0">Chris Fox</div>
                  ...
                  <li class="list-group-item d-flex align-items-center">
                    <img class="avatar rounded" src="{{asset('public/assets/img/xs/avatar6.jpg')}}" alt="">
                    <div class="flex-fill ms-2">
                      <div class="h6 mb-0">Chris Fox</div>
                  ...
                  <li class="list-group-item d-flex align-items-center">
                    <img class="avatar rounded" src="{{asset('public/assets/img/xs/avatar7.jpg')}}" alt="">
                    <div class="flex-fill ms-2">
                      <div class="h6 mb-0">Chris Fox</div>
            ...
            <div class="tab-pane fade" id="step4">
              <div class="card text-center">
                ...
                <div class="card-body">
                  <img class="img-fluid" src="{{asset('public/assets/img/project-team.svg')}}" alt="" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="ps-2">
            ...
            <div class="timeline-item ti-info p-3">
              <div class="timeline-icon">
                <img class="avatar sm rounded-circle" src="{{asset('public/assets/img/xs/avatar1.jpg')}}" alt="">
              </div>
              <div class="timeline-content ms-3">
        ...
        <div class="d-flex align-items-start">
          <div class="nav flex-column nav-pills p-3 h-100">
            <a class="nav-link rounded-circle p-1 mb-2 active" href="javascript:void(0);" data-bs-toggle="pill" data-bs-target="#c-user-1" title="">
              <img class="avatar sm rounded-circle border" src="{{asset('public/assets/img/xs/avatar1.jpg')}}" alt="avatar">
            </a>
            <a class="nav-link rounded-circle p-1 mb-2" href="javascript:void(0);" data-bs-toggle="pill" data-bs-target="#c-user-2" title="">
              <img class="avatar sm rounded-circle border" src="{{asset('public/assets/img/xs/avatar2.jpg')}}" alt="avatar">
            </a>
            <a class="nav-link rounded-circle p-1 mb-2" href="javascript:void(0);" data-bs-toggle="pill" data-bs-target="#c-user-3" title="">
              <img class="avatar sm rounded-circle border" src="{{asset('public/assets/img/xs/avatar3.jpg')}}" alt="avatar">
            </a>
            <a class="nav-link rounded-circle p-1 mb-2" href="javascript:void(0);" data-bs-toggle="pill" data-bs-target="#c-user-2" title="">
              <img class="avatar sm rounded-circle border" src="{{asset('public/assets/img/xs/avatar4.jpg')}}" alt="avatar">
            </a>
            <a class="nav-link rounded-circle p-1 mb-2" href="javascript:void(0);" data-bs-toggle="pill" data-bs-target="#c-user-5" title="">
              <img class="avatar sm rounded-circle border" src="{{asset('public/assets/img/xs/avatar5.jpg')}}" alt="avatar">
            </a>
            <a class="nav-link rounded-circle p-1 mb-2" href="javascript:void(0);" data-bs-toggle="pill" data-bs-target="#c-user-1" title="">
              <img class="avatar sm rounded-circle border" src="{{asset('public/assets/img/xs/avatar6.jpg')}}" alt="avatar">
            </a>
            <a class="nav-link rounded-circle p-1 mb-2" href="javascript:void(0);" data-bs-toggle="pill" data-bs-target="#c-user-7" title="">
              <img class="avatar sm rounded-circle border" src="{{asset('public/assets/img/xs/avatar7.jpg')}}" alt="avatar">
            </a>
            <a class="nav-link rounded-circle p-1 mb-2" href="javascript:void(0);" data-bs-toggle="pill" data-bs-target="#c-user-3" title="">
              <img class="avatar sm rounded-circle border" src="{{asset('public/assets/img/xs/avatar8.jpg')}}" alt="avatar">
            </a>
            <a class="nav-link rounded-circle p-1 mb-2" href="javascript:void(0);" data-bs-toggle="pill" data-bs-target="#c-user-3" title="">
              <img class="avatar sm rounded-circle border" src="{{asset('public/assets/img/xs/avatar9.jpg')}}" alt="avatar">
            </a>
            <a class="nav-link rounded-circle p-1 mb-2" href="javascript:void(0);" data-bs-toggle="pill" data-bs-target="#c-user-1" title="">
              <img class="avatar sm rounded-circle border" src="{{asset('public/assets/img/xs/avatar10.jpg')}}" alt="avatar">
            </a>
            <a class="nav-link rounded-circle p-1 mb-2" href="javascript:void(0);" data-bs-toggle="pill" data-bs-target="#c-user-1" title="">
              <img class="avatar sm rounded-circle border" src="{{asset('public/assets/img/xs/avatar5.jpg')}}" alt="avatar">
            </a>
                ...
                <div class="card-header border-bottom py-3">
                  <div class="d-flex">
                    <a href="javascript:void(0);" title="">
                      <img class="avatar rounded-circle" src="{{asset('public/assets/img/xs/avatar1.jpg')}}" alt="avatar">
                    </a>
                    <div class="ms-3">
                    ...
                    <li class="mb-3 d-flex flex-row align-items-end">
                      <div class="max-width-70">
                        <div class="user-info mb-1">
                          <img class="avatar xs rounded-circle me-1" src="{{asset('public/assets/img/xs/avatar1.jpg')}}" alt="avatar">
                      ...
                      <div class="max-width-70">
                        ...
                        <div class="card p-3">
                          <div class="message">
                            ...
                            <img class="w120 img-thumbnail" src="{{asset('public/assets/img/gallery/3.jpg')}}" alt="">
                            <img class="w120 img-thumbnail" src="{{asset('public/assets/img/gallery/4.jpg')}}" alt="">
                          </div>
                        </div>
                      </div>
                      <!-- More option -->
            ...
            <div class="tab-pane fade show active" id="c-user-2" role="tabpanel">
              <div class="card">
                ...
                <div class="card-header border-bottom py-3">
                  <div class="d-flex">
                    <a href="javascript:void(0);" title="">
                      <img class="avatar rounded-circle" src="{{asset('public/assets/img/xs/avatar2.jpg')}}" alt="avatar">
                    </a>
                    <div class="ms-3">
                      <h6 class="mb-0">Orlando Lentz</h6>
                      <small class="text-muted">Last seen: 2 hours ago</small>
                ...
                <div class="card-body custom_scroll" style="height: calc(100vh - 141px);">
                  <ul class="list-unstyled chat-history flex-grow-1">
                    ...
                    <li class="mb-3 d-flex flex-row align-items-end">
                      <div class="max-width-70">
                        <div class="user-info mb-1">
                          <img class="avatar xs rounded-circle me-1" src="{{asset('public/assets/img/xs/avatar2.jpg')}}" alt="avatar">
                          <span class="text-muted small">10:10 AM, Today</span>
                        </div>
                        <div class="card p-3">
                          <div class="message"> Hi Aiden, how are you?</div>
                    ...
                    <li class="mb-3 d-flex flex-row align-items-end">
                      <div class="max-width-70">
                        ...
                        <div class="card p-3">
                          <div class="message">
                            <p>Please find attached images</p>
                            <img class="w120 img-thumbnail" src="{{asset('public/assets/img/gallery/1.jpg')}}" alt="">
                            <img class="w120 img-thumbnail" src="{{asset('public/assets/img/gallery/2.jpg')}}" alt="">
                          </div>
                        </div>
                      </div>
                      <!-- More option -->
    ...
    <div class="modal-dialog modal-dialog-vertical right-side modal-dialog-scrollable">
      <div class="modal-content">
          ...
          <div class="card fieldset border setting-mode mb-4">
            ...
            <div class="c_radio d-flex text-center">
              <label class="m-1 theme-switch" for="theme-switch">
                ...
                <span class="card p-2">
                  <img class="img-fluid" src="{{asset('public/assets/img/dark-version.svg')}}" alt="Dark Mode" />
                </span>
              </label>
              <label class="m-1 theme-dark" for="theme-dark">
                <input type="checkbox" id="theme-dark" />
                <span class="card p-2">
                  <img class="img-fluid" src="{{asset('public/assets/img/dark-theme.svg')}}" alt="Theme Dark Mode" />
                </span>
              </label>
              <label class="m-1 theme-high-contrast" for="theme-high-contrast">
                <input type="checkbox" id="theme-high-contrast" />
                <span class="card p-2">
                  <img class="img-fluid" src="{{asset('public/assets/img/high-version.svg')}}" alt="High Contrast" />
                </span>
              </label>
              <label class="m-1 theme-rtl" for="theme-rtl">
                <input type="checkbox" id="theme-rtl" />
                <span class="card p-2">
                  <img class="img-fluid" src="{{asset('public/assets/img/rtl-version.svg')}}" alt="RTL Mode!" />
                </span>
              </label>
            </div>
          </div>
          ...
          <div class="card fieldset border setting-font">
            ...
            <div class="c_radio d-flex text-center font_setting">
              <label class="m-1" for="font-opensans">
                ...
                <span class="card p-2">
                  <img class="img-fluid" src="{{asset('public/assets/img/font-opensans.svg')}}" alt="Dark Mode" />
                </span>
              </label>
              <label class="m-1" for="font-quicksand">
                <input type="radio" name="font" id="font-quicksand" value="font-quicksand" />
                <span class="card p-2">
                  <img class="img-fluid" src="{{asset('public/assets/img/font-quicksand.svg')}}" alt="Dark Mode" />
                </span>
              </label>
              <label class="m-1" for="font-nunito">
                <input type="radio" name="font" id="font-nunito" value="font-nunito" checked="" />
                <span class="card p-2">
                  <img class="img-fluid" src="{{asset('public/assets/img/font-nunito.svg')}}" alt="Dark Mode" />
                </span>
              </label>
              <label class="m-1" for="font-raleway">
                <input type="radio" name="font" id="font-raleway" value="font-raleway" />
                <span class="card p-2">
                  <img class="img-fluid" src="{{asset('public/assets/img/font-raleway.svg')}}" alt="Dark Mode" />
                </span>
              </label>
            </div>
          </div>
              ...
              <li class="list-group-item setting-img">
                ...
                <div class="bg-images">
                  <ul class="list-unstyled d-flex">
                    <li class="sidebar-img-1 me-1 sidebar-img-active"><a class="rounded sidebar-img" id="img-1" href="#"><img src="{{asset('public/assets/img/sidebar-bg/sidebar-1.jpg')}}" alt="" /></a></li>
                    <li class="sidebar-img-2 me-1"><a class="rounded sidebar-img" id="img-2" href="#"><img src="{{asset('public/assets/img/sidebar-bg/sidebar-2.jpg')}}" alt="" /></a></li>
                    <li class="sidebar-img-3 me-1"><a class="rounded sidebar-img" id="img-3" href="#"><img src="{{asset('public/assets/img/sidebar-bg/sidebar-3.jpg')}}" alt="" /></a></li>
                    <li class="sidebar-img-4 me-1"><a class="rounded sidebar-img" id="img-4" href="#"><img src="{{asset('public/assets/img/sidebar-bg/sidebar-4.jpg')}}" alt="" /></a></li>
                    <li class="sidebar-img-5 me-1"><a class="rounded sidebar-img" id="img-5" href="#"><img src="{{asset('public/assets/img/sidebar-bg/sidebar-5.jpg')}}" alt="" /></a></li>
                  </ul>
                </div>
              </li>
        ...
        <div class="px-xl-4 modal-footer d-flex justify-content-start text-center">
          <button type="submit" class="btn flex-fill btn-primary lift">Save Changes</button>
  ...
  <script src="{{asset('public/assets/js/bundle/dataTables.bundle.js')}}"></script>
  <script src="{{asset('public/assets/js/bundle/apexcharts.bundle.js')}}"></script>
  <script src="{{asset('public/assets/js/bundle/select2.bundle.js')}}"></script>
  <script src="{{asset('public/assets/js/bundle/summernote.bundle.js')}}"></script>
  <script src="{{asset('public/assets/js/bundle/owlcarousel.bundle.js')}}"></script>
  <script>
  ...
  <script>
      $(document).ready(function() {
              ...
              if (this.files && this.files[0]) {
                  for (let i = 0; i < this.files.length; i++) {
                      ...
                      reader.onload = function(e) {
                          $('#preview').append('<div class="image-preview" data-index="' + i + '"><img src="' + e.target.result + '" style="width: 100px; height: 100px; margin: 5px;"><button class="delete-btn">Delete</button></div>');
                      }
          ...
          $(document).on('click', '.delete-btn', function() {
              ...
              let newFiles = Array.from(files).filter((file, i) => i !== index);
              let newFileList = new DataTransfer();
              newFiles.forEach(file => newFileList.items.add(file));
              $('#imageUpload').prop('files', newFileList.files);
          });
      });
  </script>
  ...
  <script async type="text/javascript" data-type="calendar-widget"
    src="https://www.tradays.com/c/js/widgets/calendar/widget.js?v=13">
    {
        "width": "100%",
        "height": "800px",
        "mode": "2"
  ...
  <script type="text/javascript">
    function custom_template(obj){
            ...
            if(data && data['img_src']){
                ...
                template = $("<div><img src=\"" + img_src + "\" style=\"width:80px;height:50px;\"/><p style=\"font-size:14pt;text-align:left;\">" + text + "</p></div>");
                return template;
            }
        }
    var options = {
  ...
  <script>
    // Set timer to hide success message after 5 seconds (5000 milliseconds)
    setTimeout(function() {
        ...
        removeImageButtons.forEach(button => {
            button.addEventListener('click', function() {
                ...
                if (deletedImagesInput.value === '') {
                    deletedImagesInput.value = imageToRemove;
                } else {
                    deletedImagesInput.value += ',' + imageToRemove;
                }
