...
<head>
  ...
  <link rel="stylesheet" href="{{asset('public/assets/cssbundle/dataTables.min.css')}}">
  <link rel="stylesheet" href="{{asset('public/assets/cssbundle/chartist.min.css')}}">
            ...
            <div class="tab-pane fade" id="step2">
              <div class="card mb-3">
                ...
                <ul class="list-group list-group-flush list-group-custom custom_scroll mb-0" style="height: 300px;">
                  ...
                  <li class="list-group-item d-flex align-items-center">
                    <img class="avatar rounded" src="{{asset('public/assets/img/xs/avatar8.jpg')}}" alt="">
                    <div class="flex-fill ms-2">
                      <div class="h6 mb-0">Chris Fox</div>
