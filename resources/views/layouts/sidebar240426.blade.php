        ...
        <ul class="menu-list">
          ...
          <li class="collapsed">
            ...
            <ul class="sub-menu collapse" id="menu-Expert">
              @auth
              @role('admin')
              <li><a class="ms-link" href="{{route('ea.index')}}">List</a></li>
              @endrole
              @endauth
              <li><a class="ms-link" href="{{route('ea.list')}}">List</a></li>
            </ul>
          </li>
          ...
          <ul class="sub-menu collapse" id="menu-Indicator">
            @auth
            @role('admin')
            <li><a class="ms-link" href="{{route('i.index')}}">List</a></li>
            @endrole
            @endauth
            <li><a class="ms-link" href="{{route('i.list')}}">List</a></li>
          </ul>
          </li>
          {{-- <li>
