    ...
    <div class="row g-3">
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-body">
            <form method="POST" action="{{ route('permissions.update', $permission->id) }}" class="row g-3 justify-content-center">
                @method('patch')
                @csrf
              <div class="col-lg-8 col-md-6 col-sm-6">
                <label class="form-label">Permission Name</label>
                <fieldset class="form-icon-group left-icon position-relative">
                  <input value="{{ $permission->name }}"  type="text" class="form-control"  name="name"  placeholder="Name" readonly>
