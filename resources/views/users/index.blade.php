    ...
    <div class="row g-3 mb-3 align-items-center">
      <div class="col">
        <ol class="breadcrumb bg-transparent mb-0">
          <li class="breadcrumb-item"><a class="text-secondary" href="">User Management</a></li>
            ...
            <table class="myDataTable table table-hover align-middle mb-0">
              ...
              <tbody>
                ...
                <tr>
                    ...
                    <td>
                        {{-- <a href="{{ route('users.show',[$user->id, Str::slug($user->name)]) }}"><button class="btn btn-sm btn-primary">
